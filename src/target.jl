...
function position_eci(target::MagneticTarget, position_eci::AbstractVector{<:Real}, t_jd_s::Real)
...
function position_ecef(target::MagneticTarget, position_ecef::AbstractVector{<:Real}, t_jd_s::Real)
